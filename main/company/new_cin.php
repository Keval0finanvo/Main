...
<head>
    ...
    <title>Find Latest Companies</title>
</head>
<body>
    <?php include 'nav.php';?>
    <div class="container-fluid mt-3" style="background-color:white;margin-bottom:100px;">
        <?php
            include 'config.php';
            ...
            // SQL Query
            $query = "SELECT CIN, COMPANY_NAME, DATE_OF_REGISTRATION,REGISTERED_OFFICE_ADDRESS FROM technowire_data.CIN ORDER BY DATE_OF_REGISTRATION DESC LIMIT $offset, $records_per_page";
