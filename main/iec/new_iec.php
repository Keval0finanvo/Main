...
<body>
    ...
    <div class="container">
        <?php
            ...
            // SQL Query
            $query = "SELECT IEC_Number AS 'IEC Number',Firm_Name AS 'Firm_Name', iec_Address AS 'Address' FROM iec_enquire.iec ORDER BY File_Date DESC LIMIT $offset, $records_per_page";
            ...
            if ($result && $result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    // Output table rows without hyperlinks
                    echo '<tr>';
                    foreach ($row as $key => $value) {
