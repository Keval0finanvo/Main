...
<head>
    ...
    <title>Find MSME by dists</title>
            ...
            <div class="col-12" id='main-col'>
                <div class="grid-container">
                    <?php
                        ...
                        $query = "SELECT DISTINCT District FROM msme_nic";
                        ...
                        $tableSql = "SELECT udyam_number AS 'Udyam Number', enterpris_name AS 'Enterprise Name', District AS 'District' FROM msme_nic";

                        if (!empty($selectedButtonValue)) {
                            $tableSql .= " WHERE District = '$selectedButtonValue'";
                        }
                        ...
                        if ($tableCurrentPage > 1) {
                            echo '<a href="?table_page=' . $tablePrevPage . '&dist=' . $selectedButtonValue . '" class="btn btn-primary">Previous</a>';
                        }
                        echo '<span style="margin-left:10px"></span>';
                        echo '<a href="?table_page=' . $tableNextPage . '&dist=' . $selectedButtonValue . '" class="btn btn-primary">Next</a>';
                        echo '</div>';
                    ?>
                </div>
            </div>
            <div class="col-12" id='main-col'>
                ...
                <div>
                    <?php
                        // Add dist Pagination
                        if ($distPage > 1) {
                            echo '<a href="?dist_page=' . $distPrevPage . '" class="btn btn-primary">Previous dists</a>';
                        }
                        echo '<span style="margin-left:10px"></span>';
                        echo '<a href="?dist_page=' . $distNextPage . '" class="btn btn-primary">Next dists</a>';
                    ?>
                </div>
                <br>
            </div>
